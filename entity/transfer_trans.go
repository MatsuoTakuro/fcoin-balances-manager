...
type TransferTrans struct {
	...
	FromBalance BalanceID       `db:"from_balance"` // TODO: Balanceの*structのほうが良かった？かも（api.respBodyも同様に変更？）
	ToUser      UserID          `db:"to_user"`      // TODO: 不要？Balanceの*structだけで良かったかも
	ToBalance   BalanceID       `db:"to_balance"`   // TODO: Balanceの*structのほうが良かった？かも（api.respBodyも同様に変更？）
